    ...
    return (
        <div className="footer mt-4 flex justify-between">
            <div>
                <p>rotten • egg</p></div>
            <div className='flex'>
                <a href='https://www.facebook.com/rottenegggs/' target="_blank" rel="noreferrer"><div dangerouslySetInnerHTML={{ __html: facebook }} /></a>
                <a href='https://github.com/ragingSkull' target="_blank" rel="noreferrer"><div dangerouslySetInnerHTML={{ __html: github }} /></a>
            </div>
        </div>
    );
}
